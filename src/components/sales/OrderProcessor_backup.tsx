...
//           {
//             role: "system",
//             content: `You are an expert at parsing natural language orders into structured data. 
//             Extract each product/item mentioned with its quantity and details.
//             Respond with a JSON array of objects, each containing:
//             - extractedProduct: string (the product name)
//             - quantity: number 
//             - unit: string (case, box, pack, piece, bottle, etc.)
//             - originalText: string (the original text segment)
//             - priceMentioned: number or null`
//           },
//           {
//             role: "user",
//             content: `Parse this order: "${naturalLanguageOrder}"

// Examples:
// - "10 cases of watermelon fakher" → {"extractedProduct": "watermelon fakher", "quantity": 10, "unit": "case", "originalText": "10 cases of watermelon fakher", "priceMentioned": null}
// - "5 boxes coconut coals at $8 each" → {"extractedProduct": "coconut coals", "quantity": 5, "unit": "box", "originalText": "5 boxes coconut coals at $8 each", "priceMentioned": 8}`
//           }
//         ],
//         temperature: 0.1,
//       });
...
//       // Convert to ProcessedItem format
//       const items: ProcessedItem[] = extractedItems.map((item: {
...
//         product_name: item.extractedProduct,
//         quantity: item.quantity,
//         unit: item.unit || 'piece',
//         unit_price: item.priceMentioned || 0,
//         total_price: (item.priceMentioned || 0) * item.quantity,
